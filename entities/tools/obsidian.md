...
- [Build BEAUTIFUL Diagrams with Claude Code (Full Workflow)](../../sources/build-beautiful-diagrams-with-claude-code-full-workflow.md) - "[0:07:29] putting that all together to then build the JSON file that we can render with the Obsidian Excalibraw plugin or an excalraw.com."
