...
- [Model Selection](../../concepts/model-selection.md) and [Provider Independence](../../concepts/provider-independence.md): Claude as the quality default, never the only option.
- [MCP](../../concepts/mcp.md) and [Contextual Retrieval](../../concepts/contextual-retrieval.md): two Anthropic contributions Cole teaches directly.
- [Agentic Workflow Engineering](../../concepts/agentic-workflow-engineering.md), [Context Engineering](../../concepts/context-engineering.md), and [Human in the Loop](../../concepts/human-in-the-loop.md): patterns anchored in Anthropic's guides.
- [RAG](../../concepts/rag.md): contextual retrieval feeds his retrieval stacks.
- [Claude](../tools/claude.md), [Claude Code](../tools/claude-code.md), and [Claude Agent SDK](../tools/claude-agent-sdk.md): the products he runs on.
- Peer labs [OpenAI](./openai.md) and [Google](./google.md), and creator [Cole Medin](../people/cole-medin.md).

## Sources

- [10 n8n Tips in 10 Minutes to 10x Your AI Automations](../../sources/10-n8n-tips-in-10-minutes-to-10x-your-ai-automations.md) - "[0:02:02] if you want the absolute best large language model right now I would choose anthropic and go with clae 3.5 Sonet."
...
- [Anthropic Just Dropped a Masterclass on Building Agent Harnesses (for Large Codebases)](../../sources/anthropic-just-dropped-a-masterclass-on-building-agent-harnesses-for-large-codebases.md) - "[0:00:33] Enthropic put out this article just a few days ago, how to use cloud code to work in large code bases."
...
- [The BIG Problem with MCP Servers (and the Solution!)](../../sources/the-big-problem-with-mcp-servers-and-the-solution.md) - "[0:00:00] Enthropic admitted to this problem themselves, and they literally built the protocol. So they published this blog post recently covering the main issue with MCP."
...
- [Claude Sonnet 4.5 - The New Coding King? (Sonnet 4.5 vs. GPT 5 Codex)](../../sources/claude-sonnet-45-the-new-coding-king-sonnet-45-vs-gpt-5-codex.md) - "[0:00:00] Enthropic just released Claude Sonnet 4.5 and it is looking really, really good."
...
- [Is Software Engineering Finally Dead?](../../sources/is-software-engineering-finally-dead.md) - "[0:04:18] if we look at Enthropic here, they went from a $61.5 billion valuation to a whopping $380 billion in less than a year."
...
- [Coding Agent Reliability EXPLODES When They Argue (New Adversarial Dev Technique)](../../sources/coding-agent-reliability-explodes-when-they-argue-new-adversarial-dev-technique.md) - "[0:01:37] We're going to take a lot of inspiration from Enthropic, and so I'll cover this new blog post from them."
