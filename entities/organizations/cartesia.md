...
- [Build Your First Voice AI Agent in 20 Minutes with LiveKit (Open Source)](../../sources/build-your-first-voice-ai-agent-in-20-minutes-with-livekit-open-source.md) - "[0:04:15] if you wanted to use Enthropic for the LLM instead or Cartisia for speech to text. There's a lot of different providers that are available"
