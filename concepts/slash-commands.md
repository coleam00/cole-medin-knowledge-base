...
- [Context Engineering is the New Vibe Coding](../sources/context-engineering-is-the-new-vibe-coding-learn-this-now.md) - "[0:13:35] In thecloud folder, if you have a folder called commands, any of the markdown files that you have here can be executed as custom commands for cloud code."
...
- [The 5 Techniques Separating Top Agentic Engineers Right Now](../sources/the-5-techniques-separating-top-agentic-engineers-right-now.md) - "[0:02:38] you can use these commands for any AI coding assistant, not just cloud code. They're really just prompts that define these workflows."
...
- [Build ANY AI Agent with this Context Engineering Blueprint](../sources/build-any-ai-agent-with-this-context-engineering-blueprint.md) - "[0:06:49] If you're not using cloud code, you can still use these slash commands... tell it to use the command as the prompt."
...
- [Your AI Coding Workflow NEEDS This New Agent Browser CLI](../sources/your-ai-coding-workflow-needs-this-new-agent-browser-cli.md) - "[0:11:49] I created different cloud code slashcomands to build the same validation workflow for the different tools."
...
- [I Built My Claude Code Subagents DREAM TEAM](../sources/i-built-my-claude-code-subagents-dream-team-to-create-any-ai-agent.md) - "[0:04:21] Slash commands are your way to have packaged up workflows in cloud code."
