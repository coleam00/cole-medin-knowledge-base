...
- [Function Calling with ANY LLM for Local AI Agents (Feat. LangChain, HuggingFace, and Llama 3)](../sources/function-calling-with-any-llm-for-local-ai-agents-feat-langchain-huggingface-and-llama-3.md) - "function calling is one of the most powerful pieces of the latest and greatest large language models like GPT and Claude it's what allows them to seamlessly interact with external services on your behalf" [0:00:00]
