...
- [The Future of RAG is Agentic - Learn this Strategy NOW](../sources/the-future-of-rag-is-agentic-learn-this-strategy-now.md) - "[0:38:18] I have reg for this function right here and then also structur data that I have to store in a SQL database used in this function all in the same platform because I am using superbase"
