...
- [I Was Wrong About Ralph Wiggum](../sources/i-was-wrong-about-ralph-wiggum.md) - "[0:07:06] this is the classic bash script because all Ralph is is just running cloud code in a bash loop."
...
- [Introducing Archon - an AI Agent that BUILDS AI Agents](../sources/introducing-archon-an-ai-agent-that-builds-ai-agents.md) - "[0:15:13] right now archon when it produces the Asian code immediately goes to you as the user to give feedback but what if you want it to autonomously iterate on the agent."
