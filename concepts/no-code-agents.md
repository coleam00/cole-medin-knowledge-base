...
- [How I'd Learn AI Agents FAST if I Had to Start Over (Full Roadmap)](../sources/how-id-learn-ai-agents-fast-if-i-had-to-start-over-full-roadmap.md) - "[0:05:32] I would still highly recommend starting with these no code tools... like N8N or Flowwise, other ones like Voice Flow and Relevance AI"
- [Flowise + n8n - The BEST No Code + Local AI Agent Combo](../sources/flowise-n8n-the-best-no-code-local-ai-agent-combo.md) - "[0:02:56] flow wise on the other hand is as simple as it can come and has become my go-to platform to very quickly prototype AI agents"
