...
- [10x Your AI Agents with this ONE Agent Architecture](../sources/10x-your-ai-agents-with-this-one-agent-architecture.md) - "[0:34:37] we're using this concept in Lan graph called an interrupt this is how you add human in the loop to L graph"
