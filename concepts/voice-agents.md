...
- [Build + Render ENTIRE Videos with Claude Code (Full Workflow)](../sources/build-render-entire-videos-with-claude-code-full-workflow.md) - "[0:08:39] we're going to make a single call to 11 Labs, send in the full script, get the audio out, and then we're going to sync the animation timing to the video."
