...
- [Google is Quietly Revolutionizing AI Agents (This is HUGE)](../sources/google-is-quietly-revolutionizing-ai-agents-this-is-huge.md) - "[0:04:57] maybe our sales agent is built with Langraph and then our finance agent is built without a framework at all... as long as they're all following the A2A protocol, they can communicate with each other seamlessly."
...
- [If You're Serious About Building AI Agents, This is Your Secret Weapon](../sources/if-youre-serious-about-building-ai-agents-this-is-your-secret-weapon.md) - "[0:17:32] I connect them all together with this primary agent that is given a tool with Pantic AI to call into each of these specialized sub aents."
...
- [This is Hands Down the BEST Way to Build AI Agents](../sources/this-is-hands-down-the-best-way-to-build-ai-agents.md) - "[0:04:46] you can think about it as these agents like the researcher the chart generator the router these can all be large language models that are each agents built with pantic AI"
