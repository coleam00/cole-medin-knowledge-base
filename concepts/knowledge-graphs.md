...
- [The ONLY AI Tech Stack You Need in 2026](../sources/the-only-ai-tech-stack-you-need-in-2026.md) - "[0:16:46] we need to use a large language model to extract entities and relationships from raw text and that is what graffiti helps us with."
...
- [AI Code That Fixes Itself (An MCP You Can Try Now)](../sources/ai-code-that-fixes-itself-an-mcp-you-can-try-now.md) - "[0:01:44] I have taken the entire repository in GitHub for Pyantic AI... and I have turned it into a knowledge graph that can be queried by AI coding assistance."
