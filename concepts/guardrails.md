...
- [Function Calling with ANY LLM for Local AI Agents](../sources/function-calling-with-any-llm-for-local-ai-agents-feat-langchain-huggingface-and-llama-3.md) - "[0:15:14] local models are not as powerful as GPT and Claw... there's a lot of hallucinations that can happen here"
