...
- [AI Agents: The Future of AI or a Passing Fad?](../sources/ai-agents-the-future-of-ai-or-a-passing-fad.md) - "AI agents are large language models like Claud GPT or llama that have been given the ability to interact with external service or each other and maintain persistent state to accomplish infinitely more than just an isolated chat bot" [0:00:47]
